...
const __TWEAKS_STYLE = `
  ...
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483646;
    ...
    background:rgba(30,30,30,.92);color:#fff;cursor:pointer;
  ...
  .twk-fab:hover{transform:scale(1.08);box-shadow:0 6px 20px rgba(0,0,0,.32)}
  .twk-fab svg{width:18px;height:18px}
  .twk-collapse{appearance:none;border:0;background:transparent;color:rgba(41,38,27,.45);
